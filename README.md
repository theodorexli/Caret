...
Caret.app launches pinned Screenpipe 0.4.50 on port 3031 (clipboard history on) and writes `.local/screenpipe-lease.json`. `python3 -m caret` can then ask for last-N windows, minutes, or clipboard, newest first.
